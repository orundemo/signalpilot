...
// `@saas/sdk` client class name (`SignalPilot`) is intentionally NOT part of
...
export const CLI_BIN = "signalpilot";
...
export const DEFAULT_API_URL = "https://api.signalpilot.orun.new";
