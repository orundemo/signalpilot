...
//   - `~/.config/signalpilot/credentials.json` (0600)
//   - `~/.config/signalpilot/config.json`     (0644)
//
// Override via `SIGNALPILOT_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/signalpilot` everywhere
