// `signalpilot webhook verify` — local cryptographic verification of a
// SignalPilot outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `signalpilot login`.
