...
//   - SignalPilotError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): SignalPilot {
  return new SignalPilot({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the SignalPilot class", () => {
