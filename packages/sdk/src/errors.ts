// Typed error hierarchy for the SignalPilot SDK.
//
...
// codes (forward compatibility) fall back to the generic `SignalPilotError`
...
export interface SignalPilotErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof SignalPilotError`
 * still matches.
 */
export class SignalPilotError extends Error {
  ...
  constructor(init: SignalPilotErrorInit) {
    super(init.envelope.message);
    this.name = "SignalPilotError";
...
export class BadRequestError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class UnauthenticatedError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class ForbiddenError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class NotFoundError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class ConflictError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class ValidationError extends SignalPilotError {
...
export class PreconditionFailedError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class UnsupportedError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export class InternalError extends SignalPilotError {
  constructor(init: SignalPilotErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends SignalPilotErrorInit {
...
export class RateLimitError extends SignalPilotError {
...
/**
 * Decode an HTTP `Response` into the appropriate `SignalPilotError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `SignalPilotError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new SignalPilotError(init);
  }
}

function decodeRateLimit(
  init: SignalPilotErrorInit,
  response: Response,
): RateLimitError {
