 ...
 * signature verifier for SignalPilot outbound webhook deliveries.
 *
...
/**
 * Compute the canonical SignalPilot webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a SignalPilot webhook delivery.
 *
