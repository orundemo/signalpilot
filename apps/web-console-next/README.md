...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the SignalPilot web console.
...
- Per-env Cloudflare Pages projects: `signalpilot-web-console-next-{dev,stage,prod}`
