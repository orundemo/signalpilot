...
| `orgName` | string | `signalpilot` | Org identifier |
| `owner` | string | `signalpilot` | GitHub owner |
| `repo` | string | `signalpilot` | GitHub repo |
| `namespace` | string | `signalpilot` | Logical namespace |
